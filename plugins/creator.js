...
let delay = time => new Promise(res => setTimeout(res, time))
  ...
  await conn.reply(m.chat, 'ᴍʏ ᴄʀᴇᴀᴛᴏʀ salsa ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ', fpayment)
...
isForwarded: false, 
 ...
 title: 'TʜᴇOᴡɴᴇʀ', 
 body: bottime, 
 sourceUrl: 'https://chat.whatsapp.com/KDpEpuqpZ3EDcAUuoQrMFm',
...
seconds: 22,
fileLength: 22,
 ptt: true, contextInfo: { forwardingScore: 999, isForwarded: false, externalAdReply: {title: 'ᴍʏ ᴄʀᴇᴀᴛᴏʀ salsaOfc', body: wm, sourceUrl: 'https://wa.me/6283833371747?text=Assalamualaikum', thumbnail: await (await fetch(bjir)).buffer(),}} 
 })
